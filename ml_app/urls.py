...
urlpatterns = [
    ...
    path('job-skill-clustering/', views.job_skill_clustering_analysis, name='job_skill_clustering_analysis'),
    path('job-skill-clustering/predict/', views.job_skill_clustering_predict, name='job_skill_clustering_predict'),
